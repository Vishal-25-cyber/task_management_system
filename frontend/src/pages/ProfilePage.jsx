  ...
  return (
    <div className="p-6 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left/Main Column: Avatar + Profile details */}
          ...
          <div className="card p-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 mb-6">
              ...
              <div className="relative group cursor-pointer h-20 w-20 rounded-full shadow-md overflow-hidden flex-shrink-0">
                ...
                <label className="absolute inset-0 flex flex-col items-center justify-center bg-black/55 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 cursor-pointer">
              ...
              <div className="text-center sm:text-left flex-1 min-w-0">
                ...
                <div className="flex items-center justify-center sm:justify-start gap-1.5 text-xs text-slate-400 dark:text-slate-500 mt-1.5">
